# GIE-Soliton Project
> **Nonlinear pricing dynamics and liquidity singularity detection system based on Soliton theory. Integrating fluid mechanics with quantitative finance.**
> **基于孤子理论的非线性定价动力学与流动性奇点检测系统。流体力学与量化金融的深度整合。**

## 🌐 官方门户 | Official Portal
[**Live Monitor & Interactive Teaser | 实时监控与交互摘要**](https://gie-official.github.io/gie-soliton/) 
...
## 📚 知识产权与认证 | Intellectual Property
- **Core Theory / 核心理论**: *GIE v1.0 Nonlinear Pricing Dynamics Theory*
- **Digital Object Identifier (DOI)**: `10.5281/zenodo.18668564`
- **JEL Classifications**: G12, C63
- **Keywords / 关键词**: Soliton Pricing, 5061.19, Non-linear Dynamics
